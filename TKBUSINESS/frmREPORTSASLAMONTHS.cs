    ...
    public partial class frmREPORTSASLAMONTHS : Form
    {
        ...
        public StringBuilder SETSQL_SETFASTREPORT_SASLA(string SDATES, string EDATES, string LA005, string LA007)
        {
            ...
            SB.AppendFormat(@" 
                            ...
                            ,(SELECT SUM(LA2.LA017-LA2.LA020-LA2.LA022-LA2.LA023) FROM [TK].dbo.SASLA  LA2 WHERE LA2.LA007  LIKE '1067%' AND  YEAR(LA2.LA015)=YEAR(SASLA.LA015) AND MONTH(LA2.LA015)=MONTH(SASLA.LA015)) AS '月銷貨淨額'
                            ,CONVERT(DECIMAL(16,6),SUM(LA017-LA020-LA022-LA023)/(SELECT SUM(LA2.LA017-LA2.LA020-LA2.LA022-LA2.LA023) FROM [TK].dbo.SASLA  LA2 WHERE LA2.LA007  LIKE '1067%' AND  YEAR(LA2.LA015)=YEAR(SASLA.LA015) AND MONTH(LA2.LA015)=MONTH(SASLA.LA015))) AS '佔比'
